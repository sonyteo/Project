                        ...
                        <div class="panel-body">
                            <div class="row">
                                            ...
                                            <form method="post" name="reviewform" id="review_form" class="review-form">
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <h3 class="rating-title">Write your review</h3>
                                                    </div>
                                                    <?php if (!isset($_SESSION["user"])) { ?>
                                                        <div class="col-md-12 col-sm-12">
                                                            <a href="login.php" style="display:grid;"><button class="btn btn-default btn-sm btn-info">Sign In to write reviews</button></a>
                                                        </div>
                                                        <hr />
                                                    <?php } else { ?>
                                                        <div class="col-md-12 col-sm-12">
                                                        ...
                                                        <div class="col-md-12 col-sm-12">
                                                            ...
                                                            <p><button type="submit" name="ratesubmit" class="btn btn-default btn-sm btn-info" id="srr_rating">Submit</button></p>
                                                        </div>
                                                    <?php } ?>
                                                </div>
                                            </form>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 class="rating-title">Customer Reviews</h3>
                                            <?php
