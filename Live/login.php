				...
				<div class="signin-content">
					...
					if (!isset($_POST["signin"])) { ?>
						<div class="signin-image">
							...
							<a href="join.php" class="signup-image-link"><?= _CreateAnAccount ?></a>
						</div>
						<div class="signin-form">
							<h2 class="form-title"><?= _SignIn ?></h2>
							<form method="POST" class="register-form" id="login-form">
								<div class="form-group">
									<label for="email"><i class="zmdi zmdi-account material-icons-name"></i></label>
									<input type="email" name="email" id="your_name" placeholder="<?= _YourEmail ?>" required />
								</div>
								<div class="form-group">
									<label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
									<input type="password" name="pass" id="your_pass" placeholder="<?= _Password ?>" required />
								</div>
								<div class="form-group">
									<input type="checkbox" name="remember-me" id="remember-me" class="agree-term" />
									<label for="remember-me" class="label-agree-term"><span><span></span></span><?= _RememberMe ?></label>
								</div>
								<div class="form-group form-button">
									<input type="submit" name="signin" id="signin" class="form-submit" value="<?= _LogIn ?>" />
								</div>
							</form>
						</div>
					<?php } else {
